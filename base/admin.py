...
class OrderProductAdmin(admin.ModelAdmin):
    """
    Admin interface for OrderProduct model.
    """
    list_display = ('order', 'product', 'size', 'quantity', 'total_size', 'unit_price', 'total_price')
    search_fields = ('order__orderId', 'product__name')
    list_filter = ('order__created_at', 'product')
    readonly_fields = ('total_size', 'total_price')

    fieldsets = (
        (None, {
            'fields': ('order', 'product', 'size', 'quantity', 'unit_price', 'total_size', 'total_price')
        }),
    )
